<!-- Displays a selected restaurant, allows users to review said restaurant. Uses restaurants.json to read in
    data about each restaurant's name, address, url, description, and images. Used with the review-helper.php
    file to allow users to write reviews, as well as display-reviews.php and get-ratings.php, both used for
    displaying the ratings users give to various restaurants.

    Written by: Christopher Tonkin, Malik Mukdadi, Kollin Labowski -->
...
<main>
    ...
    <script src="js/restpage.js"></script>
    ...
    <div class="nologin" style="text-align: center; background-color: gray; opacity: 0.9; margin-top: 170;">
        <h1>Please login to read and write reviews for this restaurant</h1>
    </div>
